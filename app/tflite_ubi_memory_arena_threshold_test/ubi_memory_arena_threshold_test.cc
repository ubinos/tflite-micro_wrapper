...
// RecordingUbiMicroAllocator's overhead
...
void ValidateModelAllocationThresholds(
    const tflite::RecordingUbiMicroAllocator& allocator,
    const ModelAllocationThresholds& thresholds) {
  MicroPrintf("Overhead from RecordingUbiMicroAllocator is %d",
              tflite::RecordingUbiMicroAllocator::GetDefaultTailUsage());
...
TF_LITE_MICRO_TEST(TestKeywordModelMemoryThreshold) {
  ...
  tflite::RecordingUbiMicroInterpreter interpreter(
